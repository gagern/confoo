 ...
 * {@link net.von_gagern.martin.confoo.mesh.LocatedMesh LocatedMesh}
 * interface.<p>
 *
 * The 2D classes provide an implementation for meshes in two
 * dimensions. While classes like
 * {@link net.von_gagern.martin.confoo.mesh.Triangle2D Triangle2D}
 * represent new geometric objects,
 * {@link net.von_gagern.martin.confoo.mesh.Edge2D Edge2D} and
 * {@link net.von_gagern.martin.confoo.mesh.Vertex2D Vertex2D} only add
